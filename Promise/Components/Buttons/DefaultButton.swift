...
final class DefaultButton : BaseButton {
    
    public let windowWidth = UIScreen.main.bounds.size.width
    public let windowHeight = UIScreen.main.bounds.size.height
    
    // MARK: - 백그라운드 색상
    private let activeColor: UIColor = UIColor(cgColor: CGColor(red: 130/225, green: 130/225, blue: 130/225, alpha: 1))
    private let inactiveColor: UIColor = UIColor(cgColor: CGColor(red: 130/225, green: 130/225, blue: 130/225, alpha: 0.7))
